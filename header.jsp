            ...
            <div class="container topbar bg-primary d-none d-lg-block">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="top-link pe-2">
                        <a href="#" class="text-white"  data-bs-toggle="modal" data-bs-target="#term_condition"><small class="text-white mx-2">Terms & Condition</small></a>
                    </div>
                </div>
            </div>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="allAdvertise.jsp" class="nav-item nav-link">All Advertisement</a>
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <a href="signup.jsp" class="my-auto btn btn-primary text-dark px-1 mx-2 px-3">
                                Sign up
                            </a>
                            <a href="login.jsp" class="my-auto btn btn-primary text-dark px-1 px-3">
                                Login
                            </a>
                        </div>
                    </div>
