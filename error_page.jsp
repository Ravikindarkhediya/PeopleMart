    ...
    <div class="container py-5 text-center">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <h1 class="mb-4"> <%= request.getAttribute("exception") != null ? request.getAttribute("exception") : "Page not found" %> </h1>

                <p class="mb-4">Sorry! Something went wrong...Please try again.</p>
